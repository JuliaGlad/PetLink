package petlink.android.feature_profile_ui_settings.dialog.update_email
    ...
    private fun initUpdateButton() {
        binding.buttonSend.setOnClickListener {
            ...
            if (email.isNotEmpty() && password.isNotEmpty()){
                ...
                binding.textLayoutNewEmail.error = getString(petlink.android.core_ui.R.string.this_field_cannot_be_empty)
