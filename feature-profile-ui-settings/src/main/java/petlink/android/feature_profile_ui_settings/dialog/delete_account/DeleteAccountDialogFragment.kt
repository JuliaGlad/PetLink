package petlink.android.feature_profile_ui_settings.dialog.delete_account
...
import petlink.android.feature_profile_ui_settings.dialog.delete_account.di.DaggerDeleteAccountComponent
...
class DeleteAccountDialogFragment: DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DaggerDeleteAccountComponent.factory().create(profileComponent).inject(this)
    ...
    private fun initDeleteButton() {
        binding.buttonDelete.setOnClickListener {
            ...
            if (password.isNotEmpty()){
                ...
                binding.textLayoutPassword.error = getString(petlink.android.core_ui.R.string.this_field_cannot_be_empty)
            }
        }
    }
