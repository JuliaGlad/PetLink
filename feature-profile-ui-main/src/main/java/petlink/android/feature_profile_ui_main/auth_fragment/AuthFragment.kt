package petlink.android.feature_profile_ui_main.auth_fragment
...
import petlink.android.feature_profile_ui_main.auth_fragment.di.DaggerAuthComponent
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthEffect
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthIntent
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthLocalDI
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthMviState
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthPartialState
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthState
import petlink.android.feature_profile_ui_main.auth_fragment.mvi.AuthStoreFactory
import petlink.android.feature_profile_ui_main.databinding.FragmentAuthBinding
...
class AuthFragment : MviBaseFragment<
        ...
        AuthIntent,
        AuthMviState,
        AuthEffect>(petlink.android.feature_profile_ui_main.R.layout.fragment_auth) {
    ...
    override fun render(state: AuthMviState) {
        when (state.state) {
            AuthState.Authenticated -> store.sendEffect(AuthEffect.NavigateToProfile)
    ...
    override fun resolveEffect(effect: AuthEffect) {
        when (effect) {
            ...
            AuthEffect.NavigateToProfile -> listener?.onRequestFragmentChange(MainProfileId.ProfileMain)
        }
    }
