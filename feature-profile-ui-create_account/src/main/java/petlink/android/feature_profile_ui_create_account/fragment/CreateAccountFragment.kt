package petlink.android.feature_profile_ui_create_account.fragment
...
import petlink.android.feature_profile_ui_create_account.databinding.FragmentCreateAccountBinding
import petlink.android.feature_profile_ui_create_account.di.DaggerCreateAccountComponent
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountEffect
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountIntent
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountLocalDI
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountMviState
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountPartialState
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountState
import petlink.android.feature_profile_ui_create_account.fragment.mvi.CreateAccountStoreFactory
...
class CreateAccountFragment : MviBaseFragment<
        ...
        CreateAccountEffect>(petlink.android.feature_profile_ui_create_account.R.layout.fragment_create_account) {
    ...
    override fun resolveEffect(effect: CreateAccountEffect) {
        when (effect) {
            CreateAccountEffect.NavigateBack -> {
                screenArg?.let {
                    when (it) {
                        CreateAccountScreenArg.AuthDataArg -> requireActivity().finish()
                        CreateAccountScreenArg.OwnerDataArg ->  router.navigateTo(CreateAccountScreen.createAccountFragment(CreateAccountScreenArg.PetDataArg))
                        CreateAccountScreenArg.PetDataArg ->  router.navigateTo(CreateAccountScreen.createAccountFragment(CreateAccountScreenArg.AuthDataArg))
                    }
                }
            }
            ...
            CreateAccountEffect.NavigateToNextScreen -> {
                screenArg?.let {
                    when (it) {
                        CreateAccountScreenArg.AuthDataArg -> router.navigateTo(CreateAccountScreen.createAccountFragment(CreateAccountScreenArg.PetDataArg))
                        ...
                        CreateAccountScreenArg.PetDataArg -> router.navigateTo(CreateAccountScreen.createAccountFragment(CreateAccountScreenArg.OwnerDataArg))
                    }
                }
            }
    ...
    private fun getCities(): List<String> {
        ...
        val inputStream =
            requireContext().resources.openRawResource(R.raw.russian_cities)
